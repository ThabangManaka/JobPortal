...
namespace Backend.Migrations
{
    ...
    [Migration("20250130124419_Added Add-Migration AddPasswordSaltColumn")]
    partial class AddedAddMigrationAddPasswordSaltColumn
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.ApplicantDetail", b =>
                {
                    b.Property<int>("ApplicantDetailID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<int>("ApplicantDetailID"));
            ...
            modelBuilder.Entity("Models.ApplicantDetail", b =>
                {
                    b.HasOne("Models.JobPosts", "JobPosts")
                        .WithMany()
            ...
            modelBuilder.Entity("Models.Users", b =>
                {
                    b.HasOne("Models.Provinces", "Province")
                        .WithMany()
